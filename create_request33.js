        ...
        if (urlParams.has('prev_entry'))
        {
            ...
            $.ajax(
            {
                ...
                complete: function(result){
                    ...
                    var student_role = obj["element_1"];
                    var first_name = obj["element_2"];
                    var last_name = obj["element_3"];
                    var a_number = obj["element_4"];
                    var phone_number = obj["element_9_1"] + "-" + obj["element_9_2"] + "-" + obj["element_9_3"];
                    var alt_email = obj["element_6"];
                    var last_login = obj["element_7"];
                    var description = obj["element_8"];
